...
def test_select_block_slice():
    assert b"a really short blocka r" == select_block_slice(
        b"xxxxxxxx\00\00\00\00", b"a really short block", 23
    )

    assert b"really short blocka rea" == select_block_slice(
        b"xxxxxxxx\00\00\00\02", b"a really short block", 23
    )

    assert b"short blocka really sho" == select_block_slice(
        b"xxxxxxxx\f0\29\00\02", b"a really short block", 23
    )
