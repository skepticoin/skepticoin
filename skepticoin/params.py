SASHIMI_PER_COIN = (
    100_000_000  # bitcoin calls this (perhaps somewhat too) simply "COIN"
)
...
FIVE = (
    10 // 2
)  # every 2 minutes. bitcoin has this at 10, so we change the params below with a factor of FIVE
DESIRED_BLOCK_TIMESPAN = 10 * 60 // FIVE
BLOCKS_BETWEEN_TARGET_READJUSTMENT = 2016 * FIVE
DESIRED_TARGET_READJUSTMENT_TIMESPAN = (
    BLOCKS_BETWEEN_TARGET_READJUSTMENT * DESIRED_BLOCK_TIMESPAN
)  # every 2 weeks
